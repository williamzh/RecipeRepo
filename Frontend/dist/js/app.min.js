...
recipeRepoApp.config([ "$httpProvider", function($httpProvider) {
    ...
    $scope.previousState = $stateParams.referrer || "home.start", $scope.previousStateParams = $stateParams.referrerParams, 
    ...
    return {
        ...
        link: function(scope, elem) {
            elem.on("click", function() {
                scope.targetState ? (console.log(scope.targetState, scope.targetParams), $state.go(scope.targetState, scope.targetParams)) : $window.history.back();
            });
        },
