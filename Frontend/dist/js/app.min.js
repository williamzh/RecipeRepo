...
recipeRepoApp.config([ "$httpProvider", function($httpProvider) {
    ...
    $scope.initialize = function() {
        apiClient.getRecipe($stateParams.recipeId).then(function(recipe) {
            ...
            $scope.isAuthenticated = !0, $scope.hasError = !1;
        })["catch"](function() {
            $scope.hasError = !0;
        });
...
recipeRepoDirectives.directive("rdAlert", [ "$window", function($window) {
    ...
    return {
        ...
        controller: [ "$scope", "$location", "apiClient", "userSession", function($scope, $location, apiClient, userSession) {
            $scope.isAuthenticated = userSession.isValid(), $scope.onSearchSelect = function($item, $model, $label) {
    ...
    this.isValid = function() {
        return void 0 !== $sessionStorage.authSession && void 0 !== $sessionStorage.authSession.token;
    }, this.get = function() {
